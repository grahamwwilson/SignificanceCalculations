{
   ...
   TGraph* gr = new TGraph("ZScore-Calculator-SD-All.tpl","%lg %lg");
...
//   TAxis xaxis=gr->GetXaxis();
   gr->GetXaxis()->SetLimits(4.8, 330.0);
   gr->SetMaximum(1.0025);
   gr->SetMinimum(0.9775);
...
//   t->DrawLatex(0.5,3.5,"#pm 1 #sigma band (#chi^{2}/#nu = 2.3/4)");
   ...
   t2->SetTextSize(0.04);
   t2->SetTextAlign(12);
   t2->DrawLatex(10.0,1.001,"Evaluated in the Poisson limit (#hat{#sigma}_{b} = 0)");   
